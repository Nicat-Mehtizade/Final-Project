...
useEffect(() => {
    ...
    getUser();
        ...
        const filteredActivities = allActivities.filter((a) => {
          ...
          const isEndValid = endDate
            ...
            const isInWishlist = user?.wishlist?.includes(a._id);
        
          return isPriceInRange && isStartValid && isEndValid && isInWishlist;
        });
  ...
  return (
    ...
    <div className="max-w-[1320px] mx-auto">
      <div>
        <h1 className="text-3xl font-medium mb-10">Favorites</h1>
      {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 gap-y-10 py-5">
          {filteredActivities.length > 0 ? (
            ...
            <div className="flex items-center gap-2 font-semibold py-10"><img className="w-7" src="https://iticket.az/images/warning.svg" alt="" />No events found according to your request.</div>
          )}
        </div>
      </div>
    </div>
